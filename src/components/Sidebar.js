            ...
            <div className={`sidebar-info_more ${isActive ? 'block' : 'hidden'} lg:block transition-all duration-500`}>
                ...
                <div className="mt-5">
                    <a
                        ...
                        className="group relative flex items-stretch w-full sketch-border overflow-hidden bg-foreground text-background hover:opacity-90 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-foreground focus:ring-offset-2 focus:ring-offset-sidebar"
                    >
                        {/* GitHub icon block */}
                        <span className="flex items-center justify-center px-3 py-3 border-r-2 border-dashed border-background/20 shrink-0">
                        ...
                        {/* Label */}
                        <span className="flex-1 flex flex-col items-start justify-center px-3 py-2.5">
                            <span className="text-[9px] font-bold tracking-widest uppercase opacity-60 leading-none mb-0.5">free &amp; open source</span>
                            <span className="font-signature font-bold text-base leading-tight">Use this template →</span>
                        </span>

                        {/* Star icon */}
                        <span className="flex items-center justify-center px-3 border-l-2 border-dashed border-background/20 shrink-0 group-hover:bg-background/10 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} fill="currentColor" viewBox="0 0 24 24" className="group-hover:scale-125 transition-transform duration-300">
