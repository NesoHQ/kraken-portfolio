          ...
          <article className="active bg-card sketch-border paper-pattern p-[15px] lg:p-[30px] transition-all duration-500 relative z-10 block animate-[fadeIn_0.5s_ease_forwards]">
            <header>
              <h2 className="text-[40px] font-signature font-bold capitalize mb-[20px] relative pb-[10px] text-foreground flex items-center gap-4">
                About me
                <div className="flex-1 h-[2px] bg-foreground mt-2"></div>
              </h2>
            </header>

            <section className="about-text text-muted text-[16px] leading-relaxed space-y-6 font-light">
              <p>
            ...
            <section className="service mt-10">
              <h3 className="text-[32px] font-signature font-bold mb-[20px] text-foreground flex items-center gap-3">
            ...
            <section className="testimonials mt-12 overflow-visible">
              <h3 className="text-[32px] font-signature font-bold mb-[20px] text-foreground flex items-center gap-3">
              ...
              <ul className="flex gap-6 overflow-x-auto pb-8 scrollbar-hide py-4 snap-x">
                {[
                  ...
                  <li key={i} className="flex-shrink-0 w-full md:w-[48%] bg-card sketch-border p-[20px] relative snap-center duration-300 hover:border-accent">
                    ...
                    <p className="text-[14px] text-muted italic font-light line-clamp-3 leading-relaxed relative z-10">"{t.text}"</p>
            ...
            <section className="clients mt-8 mb-4">
              <h3 className="text-[32px] font-signature font-bold mb-[20px] text-foreground flex items-center gap-3">
        ...
        return (
          <article className="active bg-card sketch-border paper-pattern p-[15px] lg:p-[30px] transition-all duration-500 relative z-10 block animate-[fadeIn_0.5s_ease_forwards]">
              ...
              <ol className="ml-6 border-l-2 border-foreground border-dashed pl-8 space-y-10 relative">
                {[
                  ...
                  <li key={idx} className="relative group">
                    ...
                    <span className="text-muted text-[13px] font-bold tracking-widest block mb-2 uppercase">{item.period}</span>
                    <p className="text-muted font-light leading-relaxed text-[15px]">{item.text}</p>
                  </li>
                ))}
              </ol>
            </section>
            ...
            <section className="skill">
              ...
              <ul className="bg-card p-[20px] sketch-border space-y-6">
                {[
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredProjects.map((project, idx) => (
                  <li key={idx} className="group cursor-pointer">
                    ...
                    <p className="text-[13px] text-muted font-bold ml-1 uppercase tracking-wider">{project.category}</p>
                  </li>
                ))}
              </ul>
            </section>
                  ...
                  <li key={idx} className="group">
                    <a href="#" className="block w-full h-full bg-card sketch-border overflow-hidden hover:translate-x-1 hover:translate-y-1 transition-all duration-300">
                      ...
                      <div className="p-5 relative">
                        <time dateTime="2022-02-23" className="block text-[13px] text-muted font-bold tracking-widest uppercase mb-2">{blog.date}</time>
                        <h3 className="text-2xl font-signature font-bold text-foreground mb-2 leading-snug">{blog.title}</h3>
                        <p className="text-muted leading-relaxed line-clamp-2 text-[14px]">{blog.text}</p>
                      </div>
                    </a>
                  </li>
                ))}
      ...
      case "contact":
        return (
          <article className="active bg-card sketch-border paper-pattern p-[15px] lg:p-[30px] transition-all duration-500 relative z-10 block animate-[fadeIn_0.5s_ease_forwards]">
            ...
            <section className="map-container mb-12 border-[2px] border-foreground sketch-border grayscale hover:grayscale-0 transition-all duration-700">
